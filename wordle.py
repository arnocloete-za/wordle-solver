...
for word in list_of_words:
    for w in word:
        for key in vowels_dictionary:
            # print(key)
            # print(this_dictionary[key])
            if w == key:
                vowels_dictionary[key] += 1

    # get list of most characters available left in word_list
    max_char = 0
    max_char_list = []
    for key in vowels_dictionary:
        if vowels_dictionary[key] > max_char:
            max_char = vowels_dictionary[key]
            max_char_list.clear()
            max_char_list.append(key)
        elif vowels_dictionary[key] == max_char:
            max_char_list.append(key)

print("Vowels that are most common in 5 letter English words are:")
print(max_char_list)
...
for word in list_of_words:
    for w in word:
        for key in const_dictionary:
            # print(key)
            # print(this_dictionary[key])
            if w == key:
                const_dictionary[key] += 1

    # get list of most characters available left in word_list
    max_char = 0
    max_char_list = []
    for key in const_dictionary:
        if const_dictionary[key] > max_char:
            max_char = const_dictionary[key]
            max_char_list.clear()
            max_char_list.append(key)
        elif const_dictionary[key] == max_char:
            max_char_list.append(key)

print("Consonants that are most common in 5 letter English words are:")
print(max_char_list)
